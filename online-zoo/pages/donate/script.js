...
<div class="container_social">
    <a href="https://www.instagram.com/explore/tags/rollingscopes/" target="_blank">
        <div class="social_circle">
...
<div class="container_social">
    <a href="https://www.youtube.com/user/therollingscopes" target="_blank">
        <div class="social_circle">
    ...
    <div class="footer__rigth-wrapper">
        ...
        <form action="/" class="footer__subscribe">
            ...
            <div class="subscribe_input_container">
                <input class="subscribe_input" type="email" id="email" placeholder="Enter your email">
